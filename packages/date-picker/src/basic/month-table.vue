...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'ft-ui/src/utils/date-util';
  import { hasClass } from 'ft-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'ft-ui/src/utils/util';
