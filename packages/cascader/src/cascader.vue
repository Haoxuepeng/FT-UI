...
<script>
import Popper from 'ft-ui/src/utils/vue-popper';
import Clickoutside from 'ft-ui/src/utils/clickoutside';
import Emitter from 'ft-ui/src/mixins/emitter';
import Locale from 'ft-ui/src/mixins/locale';
import Migrating from 'ft-ui/src/mixins/migrating';
import ElInput from 'ft-ui/packages/input';
import ElTag from 'ft-ui/packages/tag';
import ElScrollbar from 'ft-ui/packages/scrollbar';
import ElCascaderPanel from 'ft-ui/packages/cascader-panel';
import AriaUtils from 'ft-ui/src/utils/aria-utils';
import { t } from 'ft-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'ft-ui/src/utils/util';
import { isUndefined, isFunction } from 'ft-ui/src/utils/types';
import { isDef } from 'ft-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'ft-ui/src/utils/resize-event';
